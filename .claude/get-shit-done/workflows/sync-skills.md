...
INSTALL_JS_GLOBAL="/Users/jp/Projects/Personal/aurora/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/jp/Projects/Personal/aurora/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
