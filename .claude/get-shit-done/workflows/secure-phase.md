...
```
Task(
  prompt="Read /Users/jp/Projects/Personal/aurora/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jp/Projects/Personal/aurora/.claude/get-shit-done/templates/SECURITY.md`
