...
```bash
cp "/Users/jp/Projects/Personal/aurora/.claude/get-shit-done/USER-PROFILE.md" "/Users/jp/Projects/Personal/aurora/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/Users/jp/Projects/Personal/aurora/.claude/USER-PROFILE.backup.md"
```
