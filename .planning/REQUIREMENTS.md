...
- [x] **MEM-02**: Assistant retrieves relevant long-term memories during new questions.
- [x] **MEM-03**: Assistant combines knowledge base evidence and memory evidence in a single response flow.
